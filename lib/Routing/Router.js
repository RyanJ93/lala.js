 ...
 *
 * @mixes Middlewares, ParamMiddlewares, Permissions, Policies, HeaderManagement, CORSManagement
 */
class Router extends mixin(Middlewares, ParamMiddlewares, Permissions, Policies, HeaderManagement, CORSManagement) {
    /**
    ...
    setPrefix(prefix){
        ...
        this._prefix = prefix === null || prefix === '' ? '' : ( prefix.charAt(0) !== '/' ? ( '/' + prefix ) : prefix );
        return this;
    }
     ...
     * @param {(controllerCallback|ControllerClosure)} handler The function invoked to handle this request, alternatively, an instance of the "ControllerClosure" class can be used.
    ...
    /**
     * Adds a route suitable to handle OPTIONS requests.
     *
     * @param {(string|RegExp|string[]|RegExp[])} route A string containing the route pattern, alternatively, a regex is accepted as well as an array containing multiple paths for this route (as strings or regex).
     * @param {(controllerCallback|ControllerClosure)} handler The function invoked to handle this request, alternatively, an instance of the "ControllerClosure" class can be used.
     * @param {RouteOptions} [options] An optional object containing the additional options for this route.
    ...
    options(route, handler, options){
        return this.addRoute('OPTIONS', route, handler, options);
    }
     ...
     *
     * @param {string} path A non empty string containing the path to this route.
     * @param {(BaseViewFactory|string)} view An instance of the view factory or a non-empty string containing the path to a view file.
