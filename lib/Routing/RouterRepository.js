...
class RouterRepository extends Repository {
     ...
     * @param {string} name A string containing the router name.
     *
     * @returns {(Router|null)} An instance of the class "Router" representing the router, if no object is found, null will be returned instead.
     *
     * @throws {InvalidArgumentException} If an invalid router name is given.
     */
    static get(name){
     ...
     *
     * @returns {{string: Router}} An object having as key the object name and as value the router itself.
     */
    static getAll(){
