...
/**
 * @typedef {Object} ResolvedRouteOptions Defined the properties to setup when creating a new instance of this class.
 *
...
/**
 * @typedef {Object} RouteResolutionStats Represents the object containing all the statistical information about route lookup process.
 *
...
class ResolvedRoute {
    ...
    constructor(route, options = null){
         ...
         * @protected
         */
        this._path = typeof options.path === 'string' ? options.path : null;
