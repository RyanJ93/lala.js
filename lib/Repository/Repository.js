...
class Repository {
     ...
     * @param {?string} [namespace=null] A string representing the namespace to use, if set to null or empty string, the global namespace will be used instead.
     ...
     * @param {?string} [namespace=null] A string containing object namespace, if set to null or empty string, the global namespace will be used instead.
     *
     * @throws {InvalidArgumentException} If an invalid name is given.
     * @throws {InvalidArgumentException} If an invalid namespace is given.
     */
