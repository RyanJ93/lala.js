...
class Repository {
     ...
     * @param {string|null} namespace A string representing the namespace to use, if set to null or empty string, the global namespace will be used instead.
     * @param {boolean} overwrite If set to "true" it means that if an object has already been registered with the same name, it will be overwritten by current one, otherwise an exception will be thrown.
     *
     ...
     * @param {string|null} namespace A string containing object namespace, if set to null or empty string, the global namespace will be used instead.
     *
     * @throws InvalidArgumentException If an invalid name is given.
     * @throws InvalidArgumentException If an invalid namespace is given.
     */
