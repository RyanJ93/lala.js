...
class Repository extends BaseRepository {
    ...
    static remove(name, namespace = null){
        ...
        // If this element was the default one within this namespace, then remove it from defaults list.
        namespace = Repository._buildNamespace(namespace);
        if ( Repository._defaults.hasOwnProperty(namespace) ){
            delete Repository._defaults[namespace];
        }
    }
     ...
     * @throws {InvalidArgumentException} If an invalid name is given.
     * @throws {InvalidArgumentException} If an invalid namespace is given.
     * @throws {InvalidArgumentException} If the given entity has not been registered first.
     */
    ...
    /**
     * Removes the default object that has been defined, note that the original object won't be removed from the repository.
     *
     * @param {?string} [namespace] A string containing object namespace, if set to null or empty string, the global namespace will be used instead.
     *
     * @throws {InvalidArgumentException} If an invalid namespace is given.
     */
    static dropDefault(namespace = null){
        namespace = Repository._buildNamespace(namespace);
        if ( Repository._defaults.hasOwnProperty(namespace) ){
            delete Repository._defaults[namespace];
        }
