...
/**
 * @typedef boudary Defines a boundary string used to separate mixed contents in a form-data POST request.
 *
...
/**
 * @typedef block Represents a form-data parameter.
 *
...
/**
 * @typedef fileBuffer Represents a file currently being uploaded.
 *
...
/**
 * @typedef tmpFileDescriptor An object representing a temporary file created to store uploaded contents.
 *
 * @property {number} fd An integer number representing the file handler used in write operations and referencing the temporary file created.
 * @property {string} path A string containing the path to the temporary file created to store the uploaded contents for this file.
 */
...
/**
 * @typedef paramStack Contains all the parameters and files found by parsing the request data sent by a client.
 *
...
/**
 * @typedef HTTPInputProcessorConfiguration An object containing all the properties supported by this class.
 *
