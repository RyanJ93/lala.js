...
class AuthorizationProcessorFactory extends ProcessorFactory {
    ...
    /**
     * Sets the name of the POST field that should contain the client provided CSRF token to verify, this method is chainable.
     *
     * @param {?string} name A string containing the field name or null if no CSRF token should be checked.
     *
     * @returns {AuthorizationProcessorFactory}
     *
    ...
    /**
     * Returns the name of the POST field that should contain the client provided CSRF token to verify.
     *
     * @returns {?string} A string containing the field name or null if no CSRF token should be checked.
     */
    getCSRFFieldName(){
