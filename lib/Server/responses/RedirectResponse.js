...
class RedirectResponse extends Response {
     ...
     * @param {boolean} [permanent=false] If set to "true" this redirection will be marked as permanent by sending 301 status code, otherwise 307 will be used instead.
     *
    ...
    constructor(url, permanent = false){
        ...
        /**
         * @type {boolean} [_permanent=false] If set to "true" number 308 status code will be used in response header, otherwise number 302 will be used instead.
         *
         * @protected
         */
