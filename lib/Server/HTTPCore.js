...
class HTTPCore extends RoutedServer {
     ...
     *
     * @param {module:net.Socket} connection An instance of the native class "Socket" representing the connection remove from the tracking list.
     *
     * @protected
     */
    _untrackConnection(connection){
        if ( typeof connection.connectionID === 'string' ){
            delete this._connections[connection.connectionID];
        }
    }

    /**
     * Closes all the currently active connections.
     *
     * @param {boolean} [force=false] If set to "true" connection will be dropped brutally.
     *
     * @protected
     */
    _killTrackedConnections(force = false){
        if ( force === true ){
            for ( const connectionID in this._connections ){
                this._connections[connectionID].end();
            }
        }else{
            for ( const connectionID in this._connections ){
    ...
    constructor(){
        ...
        /**
         * @type {Object.<string, module:net.Socket>} _connections An object containing the list of all the clients currently connected to the server.
         *
         * @protected
         */
     ...
     *
     * @returns {Object.<string, module:net.Socket>} Ann object having as key an unique ID associated to the connection and as value an instance of the native "Socket" class representing the connection.
     */
    getConnections(){
