...
class DirectoryIndexerFactory extends BaseDirectoryIndexerFactory {
    ...
    /**
     * Sets the HTML page that will be used to display entries found, this method is chainable.
     *
     * @param {View} view An instance of the class "View" representing the HTML page to use.
     *
     * @returns {DirectoryIndexerFactory}
     *
     ...
     *
     * @returns {View} An instance of the class "View" representing the HTML page being used.
     */
    getView(){
        return this._view;
    }
