...
class HTTPMultiPartFormDataParser {
    ...
    _pushParameterToStack(){
        ...
        if ( this._currentParameter.file === null ){
            ...
            const file = new UploadedFile(this._currentParameter.file.path, this._currentParameter.file.filename, this._currentParameter.size);
            if ( isArray ){
    ...
    constructor() {
         ...
         * @protected
         */
        this._temporaryUploadedFileDirectoryEnsured = false;
    }
