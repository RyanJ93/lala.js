...
/**
 * An interceptor that allows to limit requests count.
 */
class RateLimitInterceptor extends Interceptor {
    ...
    _getCacheHandlerObject(){
        ...
        if ( handler === null ){
            ...
            handler = CacheRepository.get('@RateLimitInterceptor')
        }
        if ( handler === null ){
     ...
     */
    _getNamespaceString(){
        let namespace = 'com.lala.interceptor.rateLimit';
...
module.exports = RateLimitInterceptor;
