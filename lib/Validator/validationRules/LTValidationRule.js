...
/**
 * Implements the validation rule that allows to check if a number is lower than a given one.
 */
class LTValidationRule extends NumericComparisonValidationRule {
    /**
     ...
     */
    getMessage() {
        return 'Field {fieldName} must be lower than ' + this._compareValue + '.';
    }
}
 ...
 * @default
 */
Object.defineProperty(LTValidationRule, 'RULE_NAME', {
    value: 'lt',
    writable: false
});

module.exports = LTValidationRule;
