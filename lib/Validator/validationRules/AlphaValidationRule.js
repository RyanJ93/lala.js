...
/**
 * Validate a value checking that it contains alphabetic characters only.
 */
class AlphaValidationRule extends ValidationRule {
    /**
     ...
     */
    getMessage() {
        return 'The field {fieldName} accepts alphabetic characters only.';
    }
}
 ...
 * @default
 */
Object.defineProperty(AlphaValidationRule, 'RULE_NAME', {
    value: 'alpha',
    writable: false
});

module.exports = AlphaValidationRule;
