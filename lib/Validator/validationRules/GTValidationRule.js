...
/**
 * Implements the validation rule that allows to check if a number is greater than a given one.
 */
class GTValidationRule extends NumericComparisonValidationRule {
    /**
     ...
     */
    getMessage() {
        return 'Field {fieldName} must be greater than ' + this._comparisonValue + '.';
    }
}
 ...
 * @default
 */
Object.defineProperty(GTValidationRule, 'RULE_NAME', {
    value: 'gt',
    writable: false
});

module.exports = GTValidationRule;
