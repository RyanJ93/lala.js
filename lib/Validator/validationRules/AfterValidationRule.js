...
/**
 * Validate a date fields checking that it's a valid date and that it's more recent than a given one.
 */
class AfterValidationRule extends DateBasedValidationRule {
    /**
     ...
     */
    getMessage() {
        return 'Field {fieldName} must contain a valid date that must be more recent than ' + this._date + '.';
    }
}
 ...
 * @default
 */
Object.defineProperty(AfterValidationRule, 'RULE_NAME', {
    value: 'after',
    writable: false
});

module.exports = AfterValidationRule;
