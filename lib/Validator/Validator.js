...
class Validator {
    ...
    _addError(fieldName, fieldValue, ruleData){
        ...
        if ( this._messages.hasOwnProperty(ruleData.name) && this._messages[fieldName].hasOwnProperty(ruleData.name) && typeof this._messages[fieldName][ruleData.name] === 'string' ){
