...
/**
 * Contains all the registered connections to the installed database drivers.
 */
class ConnectionRepository extends Repository {
     ...
     * @param {string} driver A string containing the name of the database driver used by the given connection.
     *
     * @returns {object} An instance of the class that implements the connection.
     *
     * @throws {MisconfigurationException} If no default connection has been found or no default connection has been defined yet.
     */
