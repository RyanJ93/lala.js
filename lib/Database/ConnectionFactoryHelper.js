...
class ConnectionFactoryHelper {
     ...
     * @param {string|null} name A string containing an unique name of the generated connection, if given, the generated connection will be registered globally.
     * @param {boolean} overwrite If the generated connection is going to be registered globally and if the given name is taken, setting it to "true" will allow the old connection to be overwritten by this one.
     *
