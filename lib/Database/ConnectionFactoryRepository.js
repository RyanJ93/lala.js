...
class ConnectionFactoryRepository extends Repository {
     ...
     * @param {boolean} overwrite If set to "true" it means that if the factory has already been registered, it will be overwritten by current one, otherwise an exception will be thrown.
     *
