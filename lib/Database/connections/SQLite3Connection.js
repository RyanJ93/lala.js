...
/**
 * The class used to represent a connection to a SQLite powered database.
 */
class SQLite3Connection extends Connection {
    ...
    constructor(){
        ...
        /**
         * @type {string|null} _path A string containing the path where the SQLite database is located at.
         *
         * @private
         */
        this._path = null;
        ...
        /**
         * @type {string|null} _passphrase A string representing the key to use to decrypt the SQLite database define, note that currently this feature is not supported.
         *
         * @private
         */
        ...
        /**
         * @type {null} _mode An integer number representing the code of the database opening mode to use obtained by merging all the given option using the bitwise or operator.
         *
         * @private
         */
        this._mode = _sqlite3.OPEN_READWRITE | _sqlite3.OPEN_CREATE;

        /**
         * @type {number[]} _modes A sequential array of integer number containing all the database opening modes defined.
         *
         * @private
         */
        this._modes = [_sqlite3.OPEN_READWRITE, _sqlite3.OPEN_CREATE];
    }
