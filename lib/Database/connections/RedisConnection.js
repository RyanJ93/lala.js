...
/**
 * The class used to represent a connection to a single Redis server.
 */
class RedisConnection extends Connection {
    ...
    constructor(){
        ...
        /**
         * @type {string} _host A string representing the host where the Redis server is listening at.
         *
         * @private
         */
        ...
        /**
         * @type {number} [6379] _port An integer number greater than zero and lower or equal than 65535 representing the number of the port where the Memcached server is listening at.
         *
         * @private
         */
        this._port = 6379;
        ...
        /**
         * @type {string|null} _path A string containing the path to the UNIX socket file to use for Redis connection instead of a traditional network link.
         *
         * @private
         */
        this._path = null;
        ...
        /**
         * @type {number} [0] _database An integer number greater or equal than zero representing the identification number of the database where cached data will be stored in.
         *
         * @private
         */
        this._database = 0;
        ...
        /**
         * @type {string|null} _password A string containing the password to use for authentication once a connection has been established.
         *
         * @private
         */
        this._password = null;
     ...
     *
     * @returns {{string: *}} An object containing the connection parameters.
     *
     * @private
     */
    _buildOptions(){
