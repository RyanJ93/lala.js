 ...
 *
 * @param length An integer number greater than zero representing the token length.
 *
...
module.exports.mixin = (...mixins) => {
    ...
    const copyProps = (target, source) => {
        ...
        for ( let i = 0 ; i < length ; i++ ){
            if ( !properties[i].match(/^(?:constructor|prototype|arguments|caller|name|bind|call|apply|toString|length)$/) ){
