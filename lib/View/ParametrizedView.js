...
class ParametrizedView extends BaseView {
    ...
    _prepareParams(){
        ...
        if ( contextParams !== null ){
            ...
            if ( contextParams._request.CSRFToken !== null && typeof contextParams._request.CSRFToken === 'object' ){
                mergedParameters.cacheFactors.CSRFToken = contextParams._request.CSRFToken.id + '@' + contextParams._request.CSRFToken.token;
            }
        }
