 ...
 * @abstract
 */
/* abstract */ class Authenticator extends EventEmitter {
    /**
     ...
     *
     * @returns {Promise<?{user: *, identifier: string}>} An object containing both the user representation, usually an object, and a string representing its identifier.
     *
     ...
     *
     * @returns {Promise<{identifier: string, user: *}>} An object containing both the user representation, usually an object, and a string representing its identifier.
     *
     * @async
     * @protected
     */
