...
class RepositoryBasedCredentialsProvider extends CredentialsProvider {
     ...
     *
     * @param {?{string: *}} credentials An object containing the credentials having as key the unique user identifier and as value a string containing the password, alternatively, an instance of the class Credentials or an object containing the password and user data can be used.
     *
     * @returns {RepositoryBasedCredentialsProvider}
     *
