...
class Logger {
     ...
     * @param {?ReportOptions} [options] An object containing some custom options to pass to all the reporters configured.
     *
     ...
     * @async
     */
    static async log(message, options = null){
     ...
     * @param {?ErrorReportOptions} [options] An object containing some custom options to pass to all the reporters configured.
     *
     * @returns {Promise<void>}
     *
     ...
     * @async
     */
    static async logError(error, options = null){
