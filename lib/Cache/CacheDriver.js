...
const NotCallableException = require('../Exceptions/NotCallableException');
...
/* abstract */ class CacheDriver {
     ...
     */
    setOptions(options){
        this._options = typeof options !== 'object' ? null : options;
        return this;
    }
     ...
     */
    setDefaultTTL(ttl){
        this._defaultTTL = ttl === null || isNaN(ttl) || ttl <= 0 ? null : ttl;
        return this;
    }
    ...
    getComputedTTLAsTimestamp(options, milliseconds = false){
        let ttl = this.getComputedTTLAsDate(options);
