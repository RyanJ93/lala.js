...
/* abstract */ class CacheDriver {
     ...
     *
     * @returns {{signature: string, keys: Array, namespace: string}} An object containing the generated components including the hash of each key.
     *
     ...
     *
     * @param {{string: *}} options An object representing the additional options that have been passed to the original method.
     *
