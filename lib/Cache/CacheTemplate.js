...
/**
 * Represents a cache configuration template and can be used to generate one or more cache instances based on this class settings.
 */
class CacheTemplate {
    /**
     ...
     * @param {(string|null)} [connection=null] A string representing the connection name, note that the connection must have been registered first.
     *
     * @throws {DriverNotDefinedException} If a driver has been specified but is has not been registered yet.
     */
    constructor(driver = 'local', connection = null){
        /**
         * @type {string} _driver A string representing the name of the cache driver that will be applied whenever using this template.
         *
         * @private
         */
        this._driver = 'local';
        ...
        /**
         * @type {string|null} _connectionName The name that identifies the connection defined, whenever a connection is being used and it has an associated name.
         *
         * @private
         */
        ...
        /**
         * @type {string|null} _namespace The namespace that the cached item will be grouped under whenever using this template.
         *
         * @private
         */
        ...
        /**
         * @type {string|null} _path A string containing the path where the cached data will be stored in, if the cache driver supports file based storage.
         *
         * @private
         */
        this._path = null;
     ...
     *
     * @returns {Cache} An instance of the class "Cache" configured according to this class properties.
     */
    buildCacheObject(){
     ...
     * @param {boolean} [overwrite=false] If set to "true" and if another template has been registered with the same name, it will be overwritten, otherwise, an exception will be thrown.
     *
     * @returns {CacheTemplate}
     *
