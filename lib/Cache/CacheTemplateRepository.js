...
class CacheTemplateRepository extends Repository {
     ...
     * @param {boolean} [overwrite=false]  If set to "true" it means that if the template has already been registered, it will be overwritten by current one, otherwise an exception will be thrown.
     *
    ...
    /**
     * Returns all the cache configuration templates that have been registered.
     *
