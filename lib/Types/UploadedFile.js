...
class UploadedFile {
    ...
    constructor(path, filename = '', size = 0){
        ...
        if ( source !== '' ){
            ...
            this._extension = index === -1 ? '' : source.substr(index + 1).toLowerCase();
        }
    }
    ...
    /**
     * Marks this file as moved into a persistent location maintaining it in the current location, this method is chainable.
     *
     ...
     */
    delete(){
        return filesystem.promises.unlink(this._path);
    }

    /**
     * Removes this file in a synchronous way, this method is chainable.
     *
     * @returns {UploadedFile}
     */
    deleteSync(){
        filesystem.unlinkSync(this._path);
        return this;
    }
}
