...
/**
 * An exception that should be thrown when interfacing to an external service or provider is required but no driver for it has been defined.
 */
...
module.exports = DriverNotDefinedException;
