...
/**
 * An exception that should be thrown when no credentials has been provided or wrong credentials has been sent but this service requires valid user credentials, namely, the 401 HTTP error.
 */
