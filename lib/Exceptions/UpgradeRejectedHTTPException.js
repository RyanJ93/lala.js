...
/**
 * An exception that should be thrown whenever a client upgrade request fails to to rejection by some control layer.
 */
class UpgradeRejectedHTTPException extends HTTPException {
    /**
    ...
    static getHTTPMessage(){
        return 'Protocol upgrade rejected';
    }
...
module.exports = UpgradeRejectedHTTPException;
