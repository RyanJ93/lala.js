...
/**
 * An exception that should be thrown whenever a stored token expires or became invalid due to a huge number of uses.
 */
class TokenExpiredHTTPException extends HTTPException {
    /**
...
module.exports = TokenExpiredHTTPException;