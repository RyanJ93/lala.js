...
/**
 * An exception that should be thrown when an error occurs in string parsing or decoding, for instance when a syntax error occurs while parsing a non valid JSON encoded string.
 */
